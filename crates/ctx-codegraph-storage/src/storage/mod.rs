...
pub use rebuild::{
    StagedFileUpdate, compute_affected_set, compute_affected_set_with_registry, ensure_index,
    rebuild_index_db, rebuild_index_db_with_registry, run_full_rebuild, run_incremental_update,
